  ...
  return (
    <div className="w-full mx-auto px-2 sm:px-4 mb-4 sm:mb-6">
      <Link href={`/blog/${id}`} target="_blank" className="block">
        <div className="flex flex-col md:flex-row gap-3 sm:gap-4 shadow-lg shadow-neutral-600/10 p-3 sm:p-4 md:p-6 rounded-xl sm:rounded-2xl md:rounded-3xl text-white bg-[#1c1c1c] transition-colors">
